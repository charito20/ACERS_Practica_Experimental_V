...
Pares analizados para M2 & 861 ($n=42$) & rec\'alculo al fusionar \\
...
\textbf{Aritm\'etica:} $M1a = 42/42\times100 = 100\,\%$ (luego $57/57$ tras la fusi\'on IA-02); $M1b = 16/16\times100 = 100\,\%$; $M1c = 2/2\times100 = 100\,\%$.\\
\textbf{Referencia:} $M1a\geq95\,\%$; $M1b=M1c=100\,\%$. \textbf{Veredicto:} cumple. \textbf{Nivel:} 4. \textbf{Acci\'on:} sin acci\'on.

\subsubsection*{M2 --- Consistencia}
\textbf{F\'ormula:} $M2 = 1 - \#\,\text{conflictos}/\#\,\text{pares analizados}$.\\
\textbf{Aritm\'etica:} 861 pares generados por script ($n(n-1)/2$, $n=42$); 1 conflicto directo detectado (DR-02) y cerrado $\Rightarrow M2 = 1 - 1/861 = 0{,}9988$, con cero conflictos abiertos al cierre.\\
\textbf{Referencia:} $\geq0{,}98$. \textbf{Veredicto:} cumple. \textbf{Nivel:} 4. \textbf{Acci\'on:} DR-02 resuelto y documentado en \texttt{registro\_reinspeccion\_PE5.csv}.

\subsubsection*{M3 --- Verificabilidad}
\textbf{F\'ormula:} $M3 = (\#\,\text{requisitos con criterio comprobable}/\#\,\text{totales})\times100$.\\
\textbf{Aritm\'etica:} $42/42\times100 = 100\,\%$: umbral, unidad y m\'etodo presentes en todo el cat\'alogo, incluidos los 15 requisitos de IA incorporados en PE5.\\
...
\textbf{Aritm\'etica:} $M4atr = 42/42 = 100\,\%$; $M4ade = 16/16 = 100\,\%$ sobre Must Have. La primera medici\'on de cobertura global de filas vigentes arroj\'o $28/42 = 66{,}7\,\%$, bajo la referencia, por filas de RF-17 a RF-27 pendientes de reconstrucci\'on con las diez columnas.\\
...
M2 Consistencia & 0,9988 & $\geq0{,}98$ & S\'i & 4 & 0,15 & 0,60 \\
