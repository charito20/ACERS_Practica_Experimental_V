...
\hline
\endlastfoot
M1 Completitud & M1a = 100~\% (42/42); M1b = N/D en este repositorio; M1c = 100~\% (2/2 operativos) & $\geq$95~\%; $=$100~\%; $=$100~\% & ISO 25010; 29148 & Sí (M1b con causa y acción) & Verificación cruzada de M1b contra el catálogo de casos de uso del equipo \\
\hline
M2 Consistencia & $1 - 0/116 = 1{,}00$ (pares intra-ámbito) & $\geq$0,98 y cero conflictos abiertos & ISO 25010 & Sí & Dos observaciones de solapamiento registradas sin conflicto (RF-07/RF-11/RF-13; RF-25/RF-26) \\
\hline
M3 Verificabilidad & 100~\% (42/42 con umbral, unidad y método) & $\geq$90~\% & ISO 29148 & Sí & Recomendación menor de redacción en RNF-07, RNF-09 y RNF-11 \\
\hline
M4 Trazabilidad & Adelante 16/16 en alcance Debe tener = 100~\%; atrás 42/42 = 100~\% & $\geq$90~\%; $=$100~\% & ISO 29148 & Sí & Tramo CU$\rightarrow$clase$\rightarrow$CP pendiente de verificación cruzada \\
\hline
...
Al cierre de la práctica las seis métricas alcanzan su valor de referencia: cuatro cumplieron en la primera medición y dos requirieron corrección documental aplicada durante la práctica (M5 y M6), ambas re-medidas con aritmética visible y par antes/después registrado. La única componente declarada sin valor es M1b, por perímetro del repositorio y con causa y acción registradas. La auditoría de la segunda ola respalda que la expansión a 57 requisitos nació sin degradar los indicadores: los 57 tienen criterio cuantificado y la trazabilidad de los nuevos componentes se consolida en la matriz del Paso 2.
