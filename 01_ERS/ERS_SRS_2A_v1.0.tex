...
\hline
Origen & Sesgo de subregistro documentado por el equipo: las parcelas revisadas con más frecuencia acumulan más incidencias (\texttt{fichas\_IA\_datos\_y\_monitoreo.md}). \\
\hline
Prioridad & Media \\
\hline
\end{tabular}
...
\hline
Origen & Sesgo de condiciones de captura documentado por el equipo (\texttt{fichas\_IA\_datos\_y\_monitoreo.md}). \\
\hline
Prioridad & Media \\
\hline
\end{tabular}
...
\hline
Origen & Sesgo de predominio de un único dispositivo en la captura inicial, documentado por el equipo (\texttt{fichas\_IA\_datos\_y\_monitoreo.md}). \\
\hline
Prioridad & Media \\
\hline
\end{tabular}
